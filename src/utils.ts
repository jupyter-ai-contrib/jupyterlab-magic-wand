 ...
 * @returns
 */
export function getCurrentActiveCell(notebookTracker: INotebookTracker): Cell | null | undefined {
 ...
 * @returns
 */
export function getCurrentActiveCellId(notebookTracker: INotebookTracker): string | null | undefined {
